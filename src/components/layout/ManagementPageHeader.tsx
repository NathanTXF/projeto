        ...
        <div className="relative overflow-hidden rounded-xl md:rounded-2xl bg-gradient-to-br from-[#0A2F52] to-[#05325E] p-6 md:p-8 border border-white/10 shadow-[0_22px_56px_rgba(5,50,94,0.26)]">
            ...
            <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/10 shadow-inner ring-1 ring-white/20">
                        <Icon className="h-7 w-7 text-primary-foreground" />
                    </div>
                    <div>
                        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-primary-foreground leading-tight">{title}</h1>
                ...
                {action && (
                    <Button
                        ...
                        className="ui-lift ui-focus-ring ui-press gap-2 rounded-lg font-semibold shadow-sm px-6 py-3"
                    >
