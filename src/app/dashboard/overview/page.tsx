            ...
            <div className="relative overflow-hidden rounded-2x2 bg-primary p-8 shadow-sm">
                <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-extrabold tracking-tight text-primary-foreground leading-tight">Visão Geral do Gestor</h1>
                            <p className="mt-1 text-primary-foreground/80 font-medium text-sm">Análise estratégica de desempenho e métricas corporativas.</p>
                        </div>
                    </div>
